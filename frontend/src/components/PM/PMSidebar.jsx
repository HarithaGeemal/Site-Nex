...
const PMSidebar = () => {
    return (
        <aside className="w-64 h-screen bg-steel-blue text-white p-4 flex flex-col shadow-lg z-20 sticky top-0">
            ...
            <div className="mt-auto pt-4 border-t border-concrete/30">
                <Link to="/logout" className="p-3 text-white/80 hover:text-white hover:bg-red-500/20 rounded transition-colors text-sm font-medium flex items-center gap-2">
